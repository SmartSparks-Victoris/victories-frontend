  ...
  return (
    <section className="py-[80px] bg-green-800 flex justify-center items-center">
      <div className="container mx-auto flex items-center gap-8 justify-center flex-col xl:flex-row xl:items-center xl:justify-between">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,_minmax(172px,_1fr))] md:grid-cols-[repeat(auto-fit,_minmax(272px,_1fr))] gap-[18px] bg-slate-300 xl:bg-green-300 max-w-[600px] w-[100%]">
          <div>
            <h2>2,555+</h2>
            <p>lorem ipsum</p>
          </div>
